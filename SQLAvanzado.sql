...
select facturas.idFactura, clientes.nomCliente,Facturas.fecFactura, DetalleFactura.cantidad * DetalleFactura.valUnitario as totalFactura from facturas 
...
select detallefactura.idFactura, sum(detallefactura.cantidad * detallefactura.valUnitario) as totalFactura from DetalleFactura
group by idFactura